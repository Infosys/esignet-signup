...
public class IdentityVerificationService {
    ...
    @Value("${mosip.signup.crypto.p12.filename}")
    private String p12FileName;

    @Value("${mosip.signup.crypto.p12.client-private-key.alias}")
    private String privateKeyAlias;

    @Value("${mosip.signup.crypto.p12.password}")
    ...
    private String fetchAndVerifyAccessToken(String authCode) {
        try {
            ...
            URI callback = new URI(oauthRedirectUri);//oauthRedirectUri
