...
public class IdentityVerificationServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        ReflectionTestUtils.setField(identityVerificationService, "p12FilePath", "C:\\Users\\mohdkaif.siddique\\Desktop\\WorkSpace\\keystore.p12");
    ...
    @Test
    public void initiateIdentityVerification_withInValidDetails_thenFail() throws IOException {
    ...
    private void createAndStoreKeyInP12(KeyPair keyPair, X509Certificate certificate) throws Exception {
        ...
        // Use ResourceLoader to get a reference to the resources directory
